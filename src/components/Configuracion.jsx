    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = usuarioExistente
                ? await fetch(`http://192.168.137.1:8000/api/usuarios/${usuarioExistente.id_usuario}`, {
                    method: 'PUT',
                    headers: {
                ...
                : await fetch('http://192.168.137.1:8000/api/usuarios', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
...
const GestionUsuarios = () => {
    ...
    const handleEliminarUsuario = async (id_usuario) => {
        ...
        try {
            const response = await fetch(`http://192.168.137.1:8000/api/usuarios/${id_usuario}`, {
                method: 'DELETE',
            });
            if (response.ok) {
